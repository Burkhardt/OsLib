...
- Current release line for `OsLibCore` is `3.11.2`.
- Coordinated patch-line refresh: package metadata, release notes, README links, and diagram markers stay aligned with the `RAIkeep` `3.11.2` release line.
...
- See [RELEASE_NOTES_3.11.2.md](RELEASE_NOTES_3.11.2.md) for details.
...
- Typical release command:
	- `git tag -a v3.11.2 -m "v3.11.2" && git push origin v3.11.2`
